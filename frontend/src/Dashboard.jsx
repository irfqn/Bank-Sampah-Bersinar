...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetchData("https://bank-sampah-bersinar-2.onrender.com/api/user/getTotalHarga", token).then(setTotalHarga),
      fetchData("https://bank-sampah-bersinar-2.onrender.com/api/user/getStatus", token).then(setTransaction),
      fetchData(`https://bank-sampah-bersinar-2.onrender.com/api/user/getPrice?month=${new Date().toISOString().slice(0, 7)}`).then(setPrices),
      fetchData("https://bank-sampah-bersinar-2.onrender.com/api/user/education").then(data => setEducation(data.reverse())),
