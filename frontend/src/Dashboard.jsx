...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetchData("https://bank-sampah-bersinar2-b3ffehbphqdqgshh.southeastasia-01.azurewebsites.net/api/user/getTotalHarga", token).then(setTotalHarga),
      fetchData("https://bank-sampah-bersinar2-b3ffehbphqdqgshh.southeastasia-01.azurewebsites.net/api/user/getUserStatus", token).then(data => {
        console.log("Transactions Data:", data);
        setTransaction(data);
      }),
      fetchData(`https://bank-sampah-bersinar2-b3ffehbphqdqgshh.southeastasia-01.azurewebsites.net/api/user/getPrice?month=${new Date().toISOString().slice(0, 7)}`).then(setPrices),
      fetchData("https://bank-sampah-bersinar2-b3ffehbphqdqgshh.southeastasia-01.azurewebsites.net/api/user/education").then(data => setEducation(data.reverse())),
...
const DashboardTable = ({ transactions, openModalWithImage }) => {
  ...
  const fetchTransferedPict = async (userId) => {
    try {
      ...
      const response = await fetch(`https://bank-sampah-bersinar2-b3ffehbphqdqgshh.southeastasia-01.azurewebsites.net/api/user/getTransferedPict/${userId}`, {
        headers: {
