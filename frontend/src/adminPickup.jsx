...
const PickupMain = () => {
  ...
  const fetchPickupData = async () => {
    try {
      const response = await fetch("https://bank-sampah-bersinar2-b3ffehbphqdqgshh.southeastasia-01.azurewebsites.net/api/user/pickups", {
        method: "GET",
        headers: {
  ...
  const handleSubmit = async (id) => {
    ...
    const response = await fetch(`https://bank-sampah-bersinar2-b3ffehbphqdqgshh.southeastasia-01.azurewebsites.net/api/user/updatePickupStatus/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
